...
def build_router(ctx: RouteContext):
    ...
    affected_collections = ctx.live("affected_collections")
    allowed = ctx.live("allowed")
    app = ctx.live("app")
    artwork = ctx.live("artwork")
    artwork_filename = ctx.live("artwork_filename")
    assignment = ctx.live("assignment")
    assignments = ctx.live("assignments")
    candidates = ctx.live("candidates")
    chosen = ctx.live("chosen")
    cleaned = ctx.live("cleaned")
    collection = ctx.live("collection")
    ...
    libraries = ctx.live("libraries")
    library_id = ctx.live("library_id")
    library_kind = ctx.live("library_kind")
    library_row = ctx.live("library_row")
    matches = ctx.live("matches")
    matching_titles = ctx.live("matching_titles")
    memberships = ctx.live("memberships")
    message = ctx.live("message")
    move_collection_item = ctx.live("move_collection_item")
    name = ctx.live("name")
    new_library_name = ctx.live("new_library_name")
    ...
    old_artwork = ctx.live("old_artwork")
    pair = ctx.live("pair")
    path = ctx.live("path")
    position = ctx.live("position")
    previous = ctx.live("previous")
    q = ctx.live("q")
    re = ctx.live("re")
    record_event = ctx.live("record_event")
    redirect = ctx.live("redirect")
    remove_artwork = ctx.live("remove_artwork")
    request = ctx.live("request")
    requested = ctx.live("requested")
