  ...
  const steps = [
    {
      ...
      copy: "InfoMancer is built around a simple flow: browse what you have, inspect the evidence, review what needs a decision, then choose when to make changes. This tour covers the parts you will use most.",
    },
    {
      id: "navigation",
      path: "/",
    ...
    },
    {
      ...
      copy: "Select a title to open Inspector without losing your place. Inspector brings media facts, metadata, organization, and quick tools together. Select multiple titles when you want bulk organize, metadata refresh, or matching tools.",
    },
    {
      id: "review",
      path: "/review",
      ...
      copy: "Review collects the signals InfoMancer thinks deserve attention, including Media Intelligence findings and other library-quality work. Open an item to inspect the evidence, decide what to do, and stay in the queue.",
    },
    {
      id: "tasks",
      path: "/review",
    ...
    },
    {
      ...
      title: "Search follows you",
      copy: "The header search is available throughout the workspace. Use it to jump to a title without first navigating back to Library, and use search history to revisit recent lookups.",
    },
    {
      id: "profile",
      path: "/review",
