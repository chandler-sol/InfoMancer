(() => {
  ...
  const displayStylesheetUrl = new URL("display-accessibility.css", scriptSource || window.location.href);
  if (scriptSource) displayStylesheetUrl.search = new URL(scriptSource).search;
  if (!document.querySelector('link[data-display-accessibility="1"]')) {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = displayStylesheetUrl.href;
    link.dataset.displayAccessibility = "1";
