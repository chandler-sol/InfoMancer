...
class DesktopFirstRunRecoveryTests(unittest.TestCase):
    ...
    def test_library_card_copy_has_fallback_and_manual_selection(self):
        launcher = (ROOT / "desktop/ui/index.html").read_text(encoding="utf-8")
        self.assertIn("Your Library Card #", launcher)
    ...
    def test_first_run_account_page_can_return_to_library_card(self):
        ...
        self.assertIn("Back to Library Card #", template)
