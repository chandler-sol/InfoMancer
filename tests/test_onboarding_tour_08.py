...
class OnboardingTour08ContractTests(unittest.TestCase):
    ...
    def test_inspector_step_has_visual_preview_on_mobile_and_desktop(self) -> None:
        ...
        self.assertIn('preview.className = "tour-inspector-preview"', source)
        self.assertNotIn('workspace-inspector tour-inspector-preview', source)
        self.assertNotIn('window.addEventListener("pagehide"', source)
