...
class Ui08QaContracts(unittest.TestCase):
    ...
    def test_inspector_quick_details_and_media_spacing_are_preserved(self):
        ...
        actions_pos = template.index("workspace-inspector-summary-actions")
        ...
        self.assertLess(identity_pos, actions_pos)
        self.assertLess(actions_pos, favorite_pos)
        self.assertLess(favorite_pos, details_pos)
        self.assertLess(details_pos, overview_pos)
        self.assertEqual(template.count("Open full details"), 1)
        self.assertNotIn("workspace-inspector-quick-action", template)
        self.assertIn("workspace-inspector-summary-actions", css)
